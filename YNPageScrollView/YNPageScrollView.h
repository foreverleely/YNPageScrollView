...
@protocol YNPageListViewDelegate <NSObject>
...
@protocol YNPageScrollViewDelegate <NSObject>
 ...
 */
- (UIView *)headerViewInPageScrollView:(YNPageScrollView *)pageScrollView;
...
/**
 ...
 @return 是否懒加载
 */
- (BOOL)shouldLazyLoadListInPageScrollView:(YNPageScrollView *)pageScrollView;
...
/**
 ...
 @return pageView
 */
- (UIView *)pageViewInPageScrollView:(YNPageScrollView *)pageScrollView;
...
/**
 ...
 @return listView
 */
- (NSArray <id <YNPageListViewDelegate>> *)listViewsInPageScrollView:(YNPageScrollView *)pageScrollView;
 ...
 */
- (UIView *)segmentedViewInPageScrollView:(YNPageScrollView *)pageScrollView;
/**
 返回列表的数量
 ...
 @return 列表的数量
 */
- (NSInteger)numberOfListsInPageScrollView:(YNPageScrollView *)pageScrollView;

/**
 根据index初始化一个列表实例，需实现`YNPageListViewDelegate`代理

 @param pageScrollView pageScrollView description
 @param index 对应的索引
 @return 实例对象
 */
- (id<YNPageListViewDelegate>)pageScrollView:(YNPageScrollView *)pageScrollView initListAtIndex:(NSInteger)index;
...
@interface YNPageScrollView : UIView

@property (nonatomic, weak) id<YNPageScrollViewDelegate> delegate;

/// 主列表
@property (nonatomic, strong, readonly) YNPageTableView   *mainTableView;

/// 当前滑动的子列表
@property (nonatomic, weak, readonly) UIScrollView *currentListScrollView;

/// 懒加载形式的容器
@property (nonatomic, strong, readonly) YNPageListContainerView *listContainerView;

// 当前已经加载过的可用的列表字典，key是index值，value是对应列表
@property (nonatomic, strong, readonly) NSDictionary <NSNumber *, id<YNPageListViewDelegate>> *validListDict;
